...
similar_to_peace = all_prez_embeddings.most_similar("peace", topn=20)
# print(similar_to_peace)
...
rushmore_similar_to_government =roosevelt_embeddings.most_similar("government", topn=20)
