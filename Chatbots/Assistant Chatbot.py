...
class SupportBot:
  ...
  def welcome(self):
    ...
    c_name = self.name
    will_help = input(f"Ok {c_name}, what can I help you with? ").lower()
  ...
  def how_to_pay_bill_intent(self):
    return input(f"You can pay your bill a couple of ways. 1) online at bill.codecademybank.com or 2) you can pay your bill right now with me. Can I help you with anything else, {self.c_name}? ")
